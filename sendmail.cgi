...
my $emailConfPath = "/cgi-bin/sendmail.conf";
my $query = new CGI;
...
my $recipient = "webmaster@aptechservices.com";
my $subject = &veryclean($query->param('subject'));

if (($firstname eq "") || ($email eq "") || ($recipient eq ""))
{
	&error("Email Rejected",
		"Please fill out all your name and email. Back up to the " .
